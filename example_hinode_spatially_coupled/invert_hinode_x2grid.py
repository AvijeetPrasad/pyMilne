...
def loadData(clip_threshold=0.99):
    ...
    wav, obs = doubleGrid(ut.readFits('hinode_170x170_deep.fits', ext=1).transpose(
        (1, 2, 0)).reshape((170, 170, 4, 112)) / 30000.911001378045)
    tr = np.float64([0.00240208, 0.00390950, 0.0230995, 0.123889, 0.198799, 0.116474,
                    0.0201897, 0.00704875, 0.00277027])  # source A. Asensio
